...
<div class="container-fluid py-5">
        ...
        $sql9 = "SELECT * FROM photo WHERE item_id=6";
        ...
        ?>
         <?php $conn = new PDO("mysql:host=localhost; dbname=enet888; charset=utf8","root","");
        $sql = "SELECT * FROM item WHERE item_id=6";
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                   ...
                   <button class="btn btn-primary px-3" id="item_id" value="6"><i class="fa fa-shopping-cart mr-1" ></i> Add To Cart</button>
                   <?php }else if($_SESSION["role"]=="a"){?>  
                    <p>สินค้าคงเหลือ <?php echo $row["instock"]; ?> กล่อง </p>
                <a href="edit_price.php?id=6"><button class="btn btn-primary px-3" type="submit" >Edit</button></a>
                <?php } ?>
                </div>
                <?php if($_SESSION["role"]=="m"){?>
                <p>สินค้าคงเหลือ <?php echo $row["instock"]; ?> กล่อง </p>
