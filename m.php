...
<?php include "nav.php"; ?>
    ...
    <div class="container-fluid py-5">
        <div class="small-img">
            <img src="img/mbox.jpg" onclick="myFunction(this)">
            <img src="img/best1999airpod2.jpg" onclick="myFunction(this)">
            <img src="img/1999-2.jpg" onclick="myFunction(this)">
            <img src="img/1999-3.jpg" onclick="myFunction(this)">
        </div>
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold mb-4">1999.00 Bath<del class="text-muted ml-2 ">2500.00 Bath</del></h3>
                <p>
