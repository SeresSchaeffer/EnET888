...
<?php include "nav.php"; ?>
    ...
    <div class="container-fluid py-5">
        <div class="small-img">
            <img src="img/xlbox.jpg" onclick="myFunction(this)">
            <img src="img/best5999apple7.jpg" onclick="myFunction(this)">
            <img src="img/5999-2.jpg" onclick="myFunction(this)">
            <img src="img/5999-3.jpg" onclick="myFunction(this)">
        </div>
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" id="imageBox" src="img/xlbox.jpg" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">กล่องสุ่มไซส์ XL</h3>
                <h3 class="font-weight-semi-bold mb-4">5999.00 Bath<del class="text-muted ml-2 ">6500.00 Bath</del></h3>
                <p>
