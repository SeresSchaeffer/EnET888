...
<?php include "nav.php"; ?>
    ...
    <div class="container-fluid py-5">
        ...
        $sql9 = "SELECT * FROM photo WHERE item_id=$_GET[id]";
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" id="imageBox" src="img/<?php echo $row['item_image']; ?>" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            <form action="save.php?id=<?php echo $row['item_id']?>" method="POST" enctype="multipart/form-data">
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">กล่องสุ่มไซส์ <?php echo $row['item_name']; ?></h3>
               
                <h3 class="font-weight-semi-bold mb-4"><input type="int" name="item_price" placeholder="<?php echo number_format("$row[item_price]",2)?>"> Baht<del class="text-muted ml-2 "><input type="int" name="item_price_old" placeholder="<?php echo number_format("$row[item_price_old]",2) ?>"> Baht</del></h3>
                <p>
                    <h3 class="font-weight-semi-bold mb-4">รายละเอียด</h3>
                </p>
                <p class="mb-4"><input type="text-area" name="info" placeholder="<?php echo $row['item_info']; ?>"></p>
